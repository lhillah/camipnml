...
public final class Cami2CoreModel {
	 ...
	 *             CamiException
	 */
	public final void setPlaces(CamiRepository cr) throws CamiException {
		...
		try {
			if (allPl != null) {
				...
				for (Cn aPl : allPl) {
					...
					// No place marking in a Core model.
		...
		try {
			if (allAr != null) {
				for (Ca aAr : allAr) {
					...
					// No arc valuation in a Core model.
	 ...
	 */
	public static final void setPnmlModelRepository(ModelRepository mr) {
		pnmlMr = mr;
	}
}
